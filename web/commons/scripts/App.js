...
//							  node.getUI().getIconEl().src=__ctxPath + '/common/images/parentNode.png';
...
//	});
		...
		items : [
			{
				...
				html :  '<div id="banner">' +
						...
						'		onClick="App.ChangePasswordDialog.show()">' +
						'		<img src="commons/images/mima.png" style="float:left; margin-right:5px;">修改密码</a>' +
	...
	function changeSize(sender) {
		...
		cookies.set("pWidth", sender.pWidth, expires);
		cookies.set("pHeight", sender.pHeight, expires);
		window.location = __ctxPath + '/loadPage.jsp';
	}
